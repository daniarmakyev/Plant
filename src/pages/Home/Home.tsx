  ...
  return (
    <div className="container">
      <div className={styles.homeTop}>
        ...
        <p>
          Растения в кашпо станут красивым и модным дополнением интерьера вашей квартиры
          или офиса
        </p>
      ...
      <div className={styles.homeBottom}>
        ...
        <div className={styles.cards}>
          {products && products.map((item, index) => <Card key={index} card={item} />)}
        </div>
        <Link className={styles.goTo} to={"/catalog"}>
          ПЕРЕЙТИ В КАТАЛОГ
        </Link>
      </div>
    </div>
